...
export const levels: Level[] = [
  ...
  },
  {
    ...
    description: 'Wire AC mains to a Wuyelin AC/AC adapter, connect AC outputs to an Altronix power supply board, and power a CDVI reader and maglock loop.',
    instructions: [
      'In professional security systems, DC voltages are generated by power supply boards connected to low-voltage AC/AC transformers.',
      'Wire the 120VAC Outlet (ac_out) L and N terminals to the AC/AC Transformer (smps) L (ac_l) and N (ac_n) input prongs.',
      'Wire the Transformer AC outputs (ac_out1 and ac_out2) to the Altronix Power Supply (psu1) AC input terminals (ac1 and ac2). (Once correct, the board\'s DC OK and AC ON LEDs will light up!).',
    ...
    goals: [
      'Wire the 120VAC Outlet to the AC/AC Transformer input prongs',
      'Wire the AC/AC Transformer outputs to the Altronix Power Supply AC inputs',
    ...
    preplacedComponents: [
      ...
      },
      {
        ...
        terminals: [
          { id: 'ac_l', name: 'L', type: 'in', x: -15, y: -10 },
          { id: 'ac_n', name: 'N', type: 'in', x: 15, y: -10 },
          { id: 'ac_out1', name: '16.5V', type: 'out', x: -20, y: 35 },
          { id: 'ac_out2', name: '0V', type: 'out', x: 20, y: 35 }
        ],
        state: {}
      },
      {
    ...
    hints: [
      ...
      'AC to PSU: Transformer 16.5V (ac_out1) -> Altronix AC (ac1). Transformer 0V (ac_out2) -> Altronix AC (ac2).',
      'CDVI Reader Power: Altronix (+) -> CDVI Reader 12V. Altronix (-) -> Reader GND.',
      'Control Loop: CDVI Reader TRIG -> Relay A1. Relay A2 -> Altronix (-).',
