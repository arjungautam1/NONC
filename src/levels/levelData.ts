...
export const levels: Level[] = [
  ...
  },
  {
    ...
    instructions: [
      'In professional security systems, the AC/AC transformer plugs directly into the system wall power and feeds low-voltage power to the Altronix power supply board.',
      'The AC/AC Transformer is already plugged into system wall power. Wire its DC (+) and (-) outputs (pos and neg) to the Altronix Power Supply (psu1) AC input terminals (ac1 and ac2). (Once correct, the board\'s DC OK and AC ON LEDs will light up!).',
