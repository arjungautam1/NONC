...
export const levels: Level[] = [
  ...
  },
  {
    ...
    instructions: [
      'In professional security systems, DC voltages are generated by power supply boards connected to low-voltage AC/AC transformers powered by AC outlet plugs.',
      'Wire the 120VAC Outlet (ac_out) L and N terminals to the AC/AC Transformer (smps) L (ac_l) and N (ac_n) input prongs.',
      'Wire the Transformer DC (+) and (-) outputs (pos and neg) to the Altronix Power Supply (psu1) AC input terminals (ac1 and ac2). (Once correct, the board\'s DC OK and AC ON LEDs will light up!).',
  ...
  },
  {
    ...
    instructions: [
      ...
      'Power Board: Wire the 120VAC Outlet (ac_out) L and N terminals to the AC/AC Transformer (smps) L (ac_l) and N (ac_n) input prongs.',
      'Wire the Transformer DC (+) and (-) outputs (pos and neg) to the Altronix Power Supply (ps1) AC input terminals (ac1 and ac2) to energize the board.',
